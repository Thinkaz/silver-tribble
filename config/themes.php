...
return [
    ...
    */
    ...
    'themes_path' => resource_path('views/themes'), // eg: base_path('resources/themes')
	...
	*/
	...
	'themes' => [
        'dxrk' => [
            ...
            'views-path' => 'dxrk',
            'asset-path' => 'dxrk',
            'image' => 'img/themes/dxrk.png'
        ],
        'havart' => [
            'extends' => null,
            'views-path' => 'havart',
            'asset-path' => 'havart',
            'image' => 'img/themes/havart.png'
        ],
        'lara' => [
            'extends' => null,
            'views-path' => 'lara',
            'asset-path' => 'lara',
            'image' => 'img/themes/lara.png'
        ],
        'purity' => [
            'extends' => null,
            'views-path' => 'purity',
            'asset-path' => 'purity',
            'image' => 'img/themes/purity.png'
        ]
