<x-manage>
    <form action="{{ route('manage.general.changelogs.store') }}" method="post">
        @csrf
        ...
        <div class="page-title row justify-content-between">
            ...
            <button type="submit" class="col-auto btn btn-success btn-icon-split btn-sm mr-3">
                ...
                <span class="text">Create Changelog</span>
            </button>
        </div>
        ...
        <div class="container mt-5">
            ...
            <div class="mb-3">
                ...
                <div x-data="{ labels: [] }">
                    <div class="d-flex">
                        <div class="dropdown show" x-show="getAvailableLabels(labels).length > 0">
                            <a class="btn btn-secondary dropdown-toggle btn-circle mr-3" data-toggle="dropdown">
                                +
                            </a>
