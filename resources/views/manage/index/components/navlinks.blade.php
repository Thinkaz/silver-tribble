<x-manage>
    <div class="page-title">
        <h1 class="font-weight-bold text-lg">Navigation Links <smalL>Manage Nav Links</smalL></h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{route('manage.index.navlinks.store')}}" method="post" id="create-navlink">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="icon">Link Icon</label>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="color">Link Color</label>
                            </div>
        ...
        <div class="card-footer">
            <button type="submit" form="create-navlink" class="btn btn-primary btn-icon-split">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('manage.index.navlinks.update', $link->id)}}" method="post" id="form-{{$link->id}}">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text">Link Icon</label>
                                    </div>
                                    <input type="text" class="form-control bg-light border-0 small" placeholder="fad fa-server" name="icon" value="{{$link->icon}}">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text">Link Color</label>
                                    </div>
                                    <input type="text" class="form-control bg-light border-0 small" placeholder="#673AB7" name="color" value="{{$link->color}}">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text">Link URL</label>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{route('manage.index.navlinks.destroy', $link->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="card-body text-center">
                        @if($link->icon)
                            <div class="icon mt-n5 mb-2">
                                <i class="{{$link->icon}} fa-2x p-3 rounded-circle text-white" style="background-color: {{$link->color}}"></i>
                            </div>
                        @endif
